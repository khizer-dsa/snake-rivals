...
# Parameters - head_ is a dictionary with keys defined as the coordinates
# last_direction - the previous direction along which the worm was moving
...
# ----------------------------------------------------------------------------- #
        ...
        four_dis = [99999, 99999, 99999, 99999]  # [UP, RIGHT, DOWN, LEFT]

        # checks if worm can move up
        if can_move((wormPos[HEAD_2]['x'], wormPos[HEAD_2]['y'] - 1), wormPos):
            four_dis[0] = distance[wormPos[HEAD_2]['y'] - 1][wormPos[HEAD_2]['x']]

        # checks if worm can move right
        if can_move((wormPos[HEAD_2]['x'] + 1, wormPos[HEAD_2]['y']), wormPos):
            four_dis[1] = distance[wormPos[HEAD_2]['y']][wormPos[HEAD_2]['x'] + 1]

        # checks if worm can move down
        if can_move((wormPos[HEAD_2]['x'], wormPos[HEAD_2]['y'] + 1), wormPos):
            four_dis[2] = distance[wormPos[HEAD_2]['y'] + 1][wormPos[HEAD_2]['x']]

        # checks if worm can move left
        if can_move((wormPos[HEAD_2]['x'] - 1, wormPos[HEAD_2]['y']), wormPos):
            four_dis[3] = distance[wormPos[HEAD_2]['y']][wormPos[HEAD_2]['x'] - 1]
        # Finding minimum distance amongst moving up, right, down, left
        min_dis = min(four_dis)

        if four_dis[0] < 99999 and distance[wormPos[HEAD_2]['y'] - 1][wormPos[HEAD_2]['x']] == min_dis and direction_2 != DOWN:
            direction_2 = UP

        elif four_dis[1] < 99999 and distance[wormPos[HEAD_2]['y']][wormPos[HEAD_2]['x'] + 1] == min_dis and direction_2 != LEFT:
            direction_2 = RIGHT

        elif four_dis[2] < 99999 and distance[wormPos[HEAD_2]['y'] + 1][wormPos[HEAD_2]['x']] == min_dis and direction_2 != UP:
            direction_2 = DOWN

        elif four_dis[3] < 99999 and distance[wormPos[HEAD_2]['y']][wormPos[HEAD_2]['x'] - 1] == min_dis and direction_2 != RIGHT:
            direction_2 = LEFT
